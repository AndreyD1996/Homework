...
public class homework3 {
    ...
    public static void turnHuman() {
        ...
        do {
            System.out.print("Write X - coordinates: ");
            x = scanner.nextInt() - 1;
            System.out.print("Write Y - coordinates: ");
            y = scanner.nextInt() - 1;
        } while (!validCell(y, x) || (!emptyCell(y, x)));
        map[y][x] = human;
    }
    public static boolean validCell(int y, int x) { return x >= 0 && x < sizeMapX && y >= 0 && y < sizeMapY; }


    public static boolean emptyCell(int y, int x) {return map[y][x] == empty; }
